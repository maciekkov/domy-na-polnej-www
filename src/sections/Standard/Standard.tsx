      ...
      <div className="shell standard-section__grid">
        ...
        <div className="standard-section__visuals">
          <figure className="standard-lifestyle">
            <img src="/assets/images/standard/standard-lifestyle.webp" alt="Elewacja ogrodowa domu z dużym przeszkleniem i tarasem" width="1672" height="941" loading="lazy" decoding="async" />
