  ...
  return (
    <section id="lokalizacja" className="location" aria-labelledby="location-title">
      <div className="location__media" aria-hidden="true">
        <img src="/assets/images/location-map.png" alt="" width="2048" height="682" loading="eager" decoding="async" />
      </div>
      ...
      <div className="shell location__grid">
        <div className="location__content">
          ...
          <a className="button location__cta" href={mapUrl} target="_blank" rel="noreferrer">Zobacz na mapie <ArrowRight size={17} /></a>
        </div>

        <div className="location__map" aria-label="Mapa lokalizacji inwestycji w Grabiku koło Żar">
          <a className="location__route" href={mapUrl} target="_blank" rel="noreferrer">
