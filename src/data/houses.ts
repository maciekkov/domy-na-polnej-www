...
export const houses: House[] = [
  {
    ...
    image: asset('assets/images/hero-front-photoreal.webp'), pdf: asset('pdf/karta-dom-a.pdf'),
  ...
  },
  {
    ...
    image: asset('assets/images/hero-front-photoreal.webp'), pdf: asset('pdf/karta-dom-b.pdf'),
  ...
  },
  {
    ...
    image: asset('assets/images/hero-front-photoreal.webp'), pdf: asset('pdf/karta-dom-c.pdf'),
  ...
  },
  {
    ...
    image: asset('assets/images/hero-front-photoreal.webp'), pdf: asset('pdf/karta-dom-d.pdf'),
  ...
  },
  {
    ...
    image: asset('assets/images/hero-front-photoreal.webp'), pdf: asset('pdf/karta-dom-e.pdf'),
