...
const documents: SiteDocument[] = [
  ...houses.map((house) => ({
    id: `house-${house.id.toLowerCase()}`,
    type: 'house_card' as const,
    houseId: house.id,
    title: `Karta domu ${house.id}`,
    publicUrl: house.pdf,
    version: '1.0',
    active: true,
  ...
  { id: 'privacy', type: 'privacy_policy', title: 'Polityka prywatności', publicUrl: '', version: '—', active: false, updatedAt: '—', sizeLabel: 'Brak pliku' },
  { id: 'cookies', type: 'cookies_policy', title: 'Polityka cookies', publicUrl: '', version: '—', active: false, updatedAt: '—', sizeLabel: 'Brak pliku' },
]

export const fallbackSiteData: SiteData = {
  revision: 1,
  publishedAt: '13.09.2026, 22:00',
  houses,
  contact: { ...contact, contactHours: 'Biuro MK Develop 2006 · Pon. – Pt. 9:00 – 17:00' },
  standardPdf,
